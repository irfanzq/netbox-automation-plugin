...
class VLANTaggingView(View):
    ...
    def post(self, request):
        ...
        try:
            ...
            if workflow_mode == 'analysis':
                ...
                results = self._analyze_devices(devices)
                ...
                analysis_results = self._analyze_devices(devices)
    ...
    def _analyze_devices(self, devices):
        """
        ...
        for device in devices:
            ...
            for interface in interfaces:
                interface_analysis = self._analyze_interface(interface, device)
    ...
    def _analyze_interface(self, interface, device):
        """
